# coding: utf-8
from sqlalchemy import ARRAY, Column, DateTime, Integer, MetaData, String, Table, Text, text
...
t_parameters = Table(
    ...
    Column('maximum_cardinality', Integer),
    Column('dtd_identifier', String),
    Column('parameter_default', String),
    schema='information_schema'
)
...
t_routines = Table(
    ...
    Column('as_locator', String),
    Column('created', DateTime, server_default=text("CURRENT_TIMESTAMP(2)")),
    Column('last_altered', DateTime, server_default=text("CURRENT_TIMESTAMP(2)")),
    ...
    Column('result_cast_char_set_name', String),
