...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1040, 859)
        self.centralWidget = QtWidgets.QWidget(MainWindow)
        self.centralWidget.setObjectName("centralWidget")
        self.SaveParametersFrame = QtWidgets.QFrame(self.centralWidget)
        self.SaveParametersFrame.setGeometry(QtCore.QRect(330, 680, 371, 131))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 351, 111))
        ...
        self.PFFrame = QtWidgets.QFrame(self.centralWidget)
        self.PFFrame.setGeometry(QtCore.QRect(640, 10, 371, 111))
        self.PFFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.PFFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.PFFrame.setObjectName("PFFrame")
        self.gridLayoutWidget = QtWidgets.QWidget(self.PFFrame)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 40, 351, 25))
        ...
        self.secindIndicatorFrame = QtWidgets.QFrame(self.layoutWidget)
        self.secindIndicatorFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.secindIndicatorFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.secindIndicatorFrame.setObjectName("secindIndicatorFrame")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.secindIndicatorFrame)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(-1, -1, 501, 501))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.secondIndVerticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        ...
        self.secondIndVerticalLayout.addWidget(self.firstIndicatorLabel)
        ...
        self.secondIndVerticalLayout.addWidget(self.GPPushButton, 0, QtCore.Qt.AlignHCenter)
        ...
        self.secondIndVerticalLayout.addWidget(self.strategyPushButton, 0, QtCore.Qt.AlignHCenter)
        ...
        self.secondIndVerticalLayout.addWidget(self.PMPushButton, 0, QtCore.Qt.AlignHCenter)
        ...
        self.secondIndVerticalLayout.addWidget(self.RPPushButton, 0, QtCore.Qt.AlignHCenter)
        ...
        self.secondIndVerticalLayout.addWidget(self.CYRPushButton, 0, QtCore.Qt.AlignHCenter)
        self.indicatorsHorizontalLayout.addWidget(self.secindIndicatorFrame)
        ...
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.firstIndicatorFrame)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(-1, -1, 501, 501))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.firstIndVerticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        ...
        self.firstIndVerticalLayout.addWidget(self.secondIndicatorLabel)
        ...
        self.firstIndVerticalLayout.addWidget(self.GPPushButton2, 0, QtCore.Qt.AlignHCenter)
        ...
        self.firstIndVerticalLayout.addWidget(self.strategyPushButton2, 0, QtCore.Qt.AlignHCenter)
        ...
        self.firstIndVerticalLayout.addWidget(self.PMPushButton2, 0, QtCore.Qt.AlignHCenter)
        ...
        self.firstIndVerticalLayout.addWidget(self.RPPushButton2, 0, QtCore.Qt.AlignHCenter)
        ...
        self.firstIndVerticalLayout.addWidget(self.CYRPushButton2, 0, QtCore.Qt.AlignHCenter)
        self.indicatorsHorizontalLayout.addWidget(self.firstIndicatorFrame)
        self.frame_3 = QtWidgets.QFrame(self.centralWidget)
        self.frame_3.setGeometry(QtCore.QRect(10, 680, 311, 130))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.frame_4 = QtWidgets.QFrame(self.centralWidget)
        self.frame_4.setGeometry(QtCore.QRect(710, 680, 311, 130))
